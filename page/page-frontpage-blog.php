...
/*
Template Name: Front Page (Blog - No Sidebar)
*/
...
get_header();
	...
	<?php if( $paged_static == 1) {
		...
		if( function_exists( 'pod_featured_header_container' ) ) {
			...
			<div class="main-content blog-front-page blog-front-page-no-sidebar <?php echo esc_attr( $pod_excerpt_type ); ?> <?php echo esc_attr( $pod_entries_corners ); ?> <?php echo esc_attr( $pod_entries_corners_opts ); ?> <?php echo esc_attr( $pod_resp_layout ); ?>">
				<div class="container">
					<div class="row">
