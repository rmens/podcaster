...
/*
Template Name: Podcast Archive - Grid
*/
...
$image_attributes = wp_get_attachment_image_src( $attachment_id, 'square' ); // returns an array
								...
								<article class="podpost">
									<div class="entry-content">
											...
											<div class="cover-art">
												...
												<?php if( has_post_thumbnail() ) : ?>
													...
													<?php
														...
														the_post_thumbnail( 'square-large' , array( 'class' => 'podcast_image' , 'alt' => get_the_title() , 'title' => get_the_title() ) ); ?>
												...
												<div class="hover-content no-image">
													<?php if( $arch_icon_style == "audio_icons") { ?>
														<a href="<?php the_permalink(); ?>" class="pp-permalink-icon"></a>
														<?php } else { ?>
														<a href="<?php the_permalink(); ?>" class="pp-permalink-icon"></a>
														<?php } ?>
														</div>
										...
										<div class="post-footer">
											<h4 class="title<?php echo esc_attr( $is_truncate ); ?>" title="<?php the_title(); ?>">
											...
											<?php if( $pl_active == "ssp" ) { ?>
												<span class="categories"><?php echo pod_get_ssp_series_cats($post->ID, '', '', ',&nbsp;', true); ?></span>
											<?php } else { ?>
