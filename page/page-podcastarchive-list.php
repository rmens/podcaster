...
/*
Template Name: Podcast Archive - List
*/
				...
				<div class="col-lg-12">
					...
					<div class="entries-container entries list clearfix">
						<?php if($category_posts->have_posts()) : while($category_posts->have_posts()) : $category_posts->the_post();
						 ...
						 ?>
							<article <?php post_class("podpost"); ?>>
								...
								<div class="post-content">
									...
									<div class="right">
										<div class="post-excerpt">
											...
											<h2 class="title<?php echo esc_attr( $is_truncate ); ?>"><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h2>
									
											<div class="excerpt-player">
												<?php if( $pl_active == "ssp" ) { 
													$ssp_ep_type = get_post_meta( $post->ID, 'episode_type', true );?>
													
													<?php if( $ssp_ep_type == "audio" || $post_format == "audio" ) { ?>
